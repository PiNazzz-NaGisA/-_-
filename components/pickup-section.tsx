...
export function PickupSection() {
  ...
  const experiencePlans = [
    ...
    },
    {
      ...
      description: "企画班",
      image: "/projection-mapping-image.jpg",
      tags: ["企画班", "アート"],
    ...
    },
    {
      title: "もちパンカフェ",
      description: "物販",
      image: "/mochi-pan-cafe-image.png",
      tags: ["物販", "フード", "ドリンク"],
      href: "/plans/food",
    },
    {
      title: "FLOLA（フローラ）",
      description: "物販・体験",
      image: "/flola-floating-frame-image.jpg",
      tags: ["物販", "ワークショップ", "体験"],
  ...
  const stagePlans = [
    ...
    },
    {
      ...
      description: "発表・交流",
      image: "/communication-circle-image.jpg",
      tags: ["発表", "コミュニケーション"],
    ...
    },
    {
      ...
      image: "/karaoke-contest-image.jpg",
      tags: ["音楽", "大会", "エンタメ"],
    ...
    },
    {
      title: "倉本さんのお悩み相談室",
      description: "相談・交流",
      image: "/kuramoto-consultation-image.png",
      tags: ["相談", "交流", "人生"],
